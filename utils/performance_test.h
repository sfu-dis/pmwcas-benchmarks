...
class PerformanceTest {
 protected:
  ...
  struct alignas(64) WorkerStatistics {
    WorkerStatistics() : operation_count{} {}
 ...
 public:
  ...
  virtual void Entry(size_t thread_index) { MARK_UNREFERENCED(thread_index); }
